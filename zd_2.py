...
if __name__ == '__main__':
    ...
    # https://docs.google.com/spreadsheets/d/1YDUfbpkDdT6ABQrmBjH79LNHG5pevZPYfs4dwAL2hyo/edit#gid=0 таблица с документом
    # https://datastudio.google.com/reporting/10e31414-42c2-4cd5-a5b2-b0d6db06b69a ссылка на отчет в GDS
